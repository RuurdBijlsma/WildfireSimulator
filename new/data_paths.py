...
glob_fire_path = "../data/GlobFire3/Full_GlobFireV2_Jan_2021/MODIS_BA_GLOBAL_1_1_2020.shp"
...
fire_meta_path = f'../data/fire_meta_{os.path.basename(glob_fire_path)}.npy'
